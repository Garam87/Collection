...
public class StudentService {
	...
	//						리스트 크기가 늘었다 줄었다 하기 때문에 큰 의기마 없어용
	...
	//List<Student> studenList = new LinkedList<Student>(); // 추가, 수정, 삭제 효율적
	...
	public void ex() {
		...
		//studentList.add(sc);            // 1인덱스
		//studentList.add("문자문자");      // 2인덱스
		//studentList.add(new Object());  // 3인덱스
