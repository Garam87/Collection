...
public class MapService {
	...
	public void ex2() {
		...
		// value가 Object 타입 == 어떤 객체든 Vallue에 들어올 수 있다!
		...
		Set<String> set = map.keySet(); // 키값이 저장된 Set을 반환
	...
	public void ex3() {
		...
		// * List에 저장된 Map에서 Key가 "id"인 경우의 value 를 모두 출력*
		
		// 향상된 for문
		for (Map temp : list) {
			System.out.println( temp.get("id") ); // 밸류가 출력댐
